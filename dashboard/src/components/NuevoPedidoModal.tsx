...
export function NuevoPedidoModal({ isOpen, onClose }: Props) {
    ...
    const modalContent = (
        ...
        >
            <div className="bg-gray-900 border border-gray-700 rounded-2xl w-full max-w-2xl max-h-[90vh] flex flex-col shadow-2xl animate-in zoom-in-95 duration-200">
                {/* Header */}
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4 overflow-y-auto flex-1">
                    ...
                    <div className="flex items-center gap-4 p-3 bg-cyan-500/10 border border-cyan-500/30 rounded-lg">
                        ...
                        <span className="font-mono text-cyan-400 font-bold">{nextPKLId}</span>
                            ...
                            {isDropdownOpen && (
                                ...
                                >
                                    ...
                                    <button
                                        ...
                                        className="w-full text-left px-4 py-3 text-gray-500 hover:text-gray-300 hover:bg-gray-900 transition-colors border-t border-gray-800"
                                    >
                                        + Nuevo Cliente
                                    </button>
                                </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="space-y-1 relative">
                            ...
                            <button
                                ...
                                className="w-full bg-gray-950 border border-gray-700 rounded-lg p-3 text-left flex items-center justify-between hover:border-gray-600 transition-colors"
                            >
                                <span className="text-white text-sm">{tipoActual?.label}</span>
                    ...
                    <div className="space-y-1 relative">
                        ...
                        >
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-white text-sm">{estadoActual?.label}</span>
                            </div>
                        ...
                        {isEstadoDropdownOpen && (
                            <div
                                className="absolute top-full left-0 right-0 mt-1 bg-gray-950 border border-gray-700 rounded-lg shadow-lg z-50"
                                tabIndex={0}
                                ref={(el) => el?.focus()}
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            ...
                            className="w-full bg-gray-950 border border-gray-700 rounded-lg p-3 text-white text-sm placeholder-gray-500 focus:border-cyan-500 outline-none resize-none h-24 uppercase"
                            required
                        />
                    </div>
